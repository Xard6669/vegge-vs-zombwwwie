...
Veggies.Zombie.prototype.damage = function(amount){
    ...
    //particle blood
    var emiter = this.game.add.emitter(this.x, this.y, 50);
    emiter.makeParticles('bloodParticle');
    emiter.minParticleSpeed.setTo(-100, -100);
    emiter.maxParticleSpeed.setTo(100, 100);
    emiter.gravity = 300;
    emiter.start(true, 200, null, 100);
